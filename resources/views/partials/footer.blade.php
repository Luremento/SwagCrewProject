<footer class="mt-20 bg-gray-50 pt-16 dark:bg-gray-900">
        ...
        <div class="grid grid-cols-1 gap-8 pb-12 md:grid-cols-2 lg:grid-cols-4">
            ...
            <div>
                ...
                <div class="mt-6 flex space-x-4">
                    <a href="/"
                        class="flex h-10 w-10 items-center justify-center rounded-full bg-white text-gray-600 shadow-sm transition-all duration-200 hover:-translate-y-1 hover:bg-primary-50 hover:text-primary-600 hover:shadow-md dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-primary-400">
            ...
            <!-- Подписка -->
            <div>
                <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Подписка на новости</h3>
                <p class="mt-4 text-gray-600 dark:text-gray-400">
                    Подпишитесь на нашу рассылку, чтобы получать новости о новых треках и событиях.
                </p>
                <form class="mt-4">
                    <div class="flex max-w-md flex-col space-y-3 sm:flex-row sm:space-x-3 sm:space-y-0">
                        <input type="email" placeholder="Ваш email"
                            class="rounded-full border-none bg-white px-4 py-2 text-gray-700 shadow-sm focus:outline-none focus:ring-2 focus:ring-primary-500 dark:bg-gray-800 dark:text-gray-300 dark:placeholder-gray-500">
                        <button type="submit"
