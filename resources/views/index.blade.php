        ...
        <div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <a href="/" class="group relative overflow-hidden rounded-2xl">
                <div class="aspect-video overflow-hidden">
                    <img src="https://via.placeholder.com/600x400" alt="Электронная музыка"
                        class="h-full w-full object-cover transition-transform duration-700 group-hover:scale-110">
                </div>
                <div class="absolute inset-0 bg-gradient-to-t from-black/80 via-black/50 to-transparent"></div>
                <div class="absolute bottom-0 left-0 p-6">
                    <h3 class="text-2xl font-bold text-white">Электронная музыка</h3>
                    <p class="mt-2 text-white/80">1,245 треков</p>
                </div>
            </a>
            ...
            <a href="/" class="group relative overflow-hidden rounded-2xl">
                <div class="aspect-video overflow-hidden">
                    <img src="https://via.placeholder.com/600x400" alt="Хип-хоп"
                        class="h-full w-full object-cover transition-transform duration-700 group-hover:scale-110">
                </div>
                <div class="absolute inset-0 bg-gradient-to-t from-black/80 via-black/50 to-transparent"></div>
                <div class="absolute bottom-0 left-0 p-6">
                    <h3 class="text-2xl font-bold text-white">Хип-хоп</h3>
                    <p class="mt-2 text-white/80">876 треков</p>
                </div>
            </a>
            ...
            <a href="/" class="group relative overflow-hidden rounded-2xl">
                <div class="aspect-video overflow-hidden">
                    <img src="https://via.placeholder.com/600x400" alt="Рок"
                        class="h-full w-full object-cover transition-transform duration-700 group-hover:scale-110">
                </div>
                <div class="absolute inset-0 bg-gradient-to-t from-black/80 via-black/50 to-transparent"></div>
                <div class="absolute bottom-0 left-0 p-6">
                    <h3 class="text-2xl font-bold text-white">Рок</h3>
                    <p class="mt-2 text-white/80">1,032 трека</p>
                </div>
            </a>
            ...
            <a href="/" class="group relative overflow-hidden rounded-2xl">
                <div class="aspect-video overflow-hidden">
                    <img src="https://via.placeholder.com/600x400" alt="Инструментальная"
                        class="h-full w-full object-cover transition-transform duration-700 group-hover:scale-110">
                </div>
                <div class="absolute inset-0 bg-gradient-to-t from-black/80 via-black/50 to-transparent"></div>
                <div class="absolute bottom-0 left-0 p-6">
                    <h3 class="text-2xl font-bold text-white">Инструментальная</h3>
                    <p class="mt-2 text-white/80">745 треков</p>
                </div>
            </a>
        </div>
    </div>
